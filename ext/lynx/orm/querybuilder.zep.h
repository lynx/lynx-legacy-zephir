...
ZEND_BEGIN_ARG_INFO_EX(arginfo_lynx_orm_querybuilder_preparewherestatement, 0, 0, 1)
	ZEND_ARG_INFO(0, statement)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(lynx_orm_querybuilder_method_entry) {
	...
	PHP_ME(Lynx_ORM_QueryBuilder, prepareWhereStatement, arginfo_lynx_orm_querybuilder_preparewherestatement, ZEND_ACC_PUBLIC)
