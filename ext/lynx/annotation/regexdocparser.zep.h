...
ZEND_BEGIN_ARG_INFO_EX(arginfo_lynx_annotation_regexdocparser_parseannotations, 0, 0, 0)
	ZEND_ARG_INFO(0, docComment)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_lynx_annotation_regexdocparser_parsevalue, 0, 0, 0)
