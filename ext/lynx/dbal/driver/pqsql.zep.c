...
ZEPHIR_INIT_CLASS(Lynx_DBAL_Driver_Pqsql) {
	...
	ZEPHIR_REGISTER_CLASS(Lynx\\DBAL\\Driver, Pqsql, lynx, dbal_driver_pqsql, lynx_dbal_driver_pqsql_method_entry, 0);

	zend_declare_property_null(lynx_dbal_driver_pqsql_ce, SL("eventsManager"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(lynx_dbal_driver_pqsql_ce, SL("dsn"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(lynx_dbal_driver_pqsql_ce, SL("username"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(lynx_dbal_driver_pqsql_ce, SL("password"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(lynx_dbal_driver_pqsql_ce, SL("driverOptions"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(lynx_dbal_driver_pqsql_ce, SL("connection"), ZEND_ACC_PROTECTED TSRMLS_CC);
