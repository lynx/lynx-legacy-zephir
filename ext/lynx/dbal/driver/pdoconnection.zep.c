...
ZEPHIR_INIT_CLASS(Lynx_DBAL_Driver_PDOConnection) {
	...
	ZEPHIR_REGISTER_CLASS(Lynx\\DBAL\\Driver, PDOConnection, lynx, dbal_driver_pdoconnection, lynx_dbal_driver_pdoconnection_method_entry, 0);

	zend_declare_property_null(lynx_dbal_driver_pdoconnection_ce, SL("eventsManager"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(lynx_dbal_driver_pdoconnection_ce, SL("dsn"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(lynx_dbal_driver_pdoconnection_ce, SL("username"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(lynx_dbal_driver_pdoconnection_ce, SL("password"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(lynx_dbal_driver_pdoconnection_ce, SL("driverOptions"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(lynx_dbal_driver_pdoconnection_ce, SL("connection"), ZEND_ACC_PROTECTED TSRMLS_CC);
