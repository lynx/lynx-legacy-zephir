...
#define ZEPHIR_CONCAT_VSVVSV(result, op1, op2, op3, op4, op5, op6) \
	 zephir_concat_vsvvsv(&result, op1, op2, sizeof(op2)-1, op3, op4, op5, sizeof(op5)-1, op6, 0 TSRMLS_CC);
#define ZEPHIR_SCONCAT_VSVVSV(result, op1, op2, op3, op4, op5, op6) \
	 zephir_concat_vsvvsv(&result, op1, op2, sizeof(op2)-1, op3, op4, op5, sizeof(op5)-1, op6, 1 TSRMLS_CC);
